...
localProxy = {"http": "https://127.0.0.1:8080/", "https": "https://127.0.0.1:8080/"}
...
globalExcludeUrl = ['^(?:(?!http:\/\/127.0.0.1:3456).*).$']
...
contextIncludeURL = ['http://127.0.0.1:3456.*']
# Define Context Exclude URL regular expressions. Ignored if useContextForScan
# is False. List can be empty.
contextExcludeURL = ['http://127.0.0.1:3456/logout.php',
                     'http://127.0.0.1:3456/login.php',]
...
authParams = ('scriptName=' + authScriptName + '&'
              ...
              'Target URL=http://http://127.0.0.1:3456/login.php')
...
indicatorRegex = '\QLocation: http://http://127.0.0.1:3456/login.php'
...
target = 'http://http://127.0.0.1:3456/'

# You can specify other URL in order to help ZAP discover more site locations
# List can be empty
applicationURL = ['http://http://127.0.0.1:3456/index']
